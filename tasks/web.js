  ...
  Task.prototype.doAddMethod = function(path, entity, data, callback) {
    ...
    inquirer.prompt(questions, function( answers ) {
      if(answers.name == '') {
        ...
        this.writeEntity(entity);
        var method = entity.tags.web.paths[path.id].methods[method.id];
        callback(method);
      }
    }.bind(this));
  };
        ...
        var paramInquirer = (function paramInquirer(method) {
          ...
          var questions = [
            ...
            },
            {
              ...
              when: function(answers) {
                return answers.isRequestParam != null;
              },
              default: function(answers) {
            ...
            },
            {
              ...
              message: '@RequestParam(defaultValue=?)',
              when: function(answers) {
                return answers.isRequestParam != null;
              },
              default: function(answers) {
          ...
          inquirer.prompt(questions, function (answers) {
            if(answers.paramAction != null && answers.paramName != '') {
              if(answers.paramAction == 'remove') {
                ...
                if(answers.isRequestParam) {
                  param.requestParam = {
                    value: answers.requestParamValue,
                    required: answers.requestParamRequired,
                    defaultValue: answers.requestParamDefaultValue
                  }
                }
              }
